...
STRIDE threat model report — generated 2026-08-11 16:04
...
- **Severity scale:** Built-in qualitative scale (1 of 58 threats scored with CVSS v4.0)
...
**CVSS v4.0:** 9.3 (Critical) — `CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:H/VI:H/VA:H/SC:H/SI:H/SA:H` — Scored with the platform team in the NVD v4.0 calculator.
...
#### T-50 · [D] Availability of "Application logs" as a dependency — **LOW**
